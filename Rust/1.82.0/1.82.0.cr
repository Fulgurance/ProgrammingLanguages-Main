class Target < ISM::Software
    ...
    def build
        ...
        runPythonCommand(   arguments:      "./x.py build library/std --stage 0 --target #{Ism.settings.systemTarget}.json",
    ...
    def prepareInstallation
        ...
        runPythonCommand(   arguments:      "./x.py install rustc std cargo --target #{Ism.settings.systemTarget}.json",
                            path:           buildDirectoryPath,
