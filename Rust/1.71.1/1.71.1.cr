class Target < ISM::Software
    ...
    def build
        ...
        runPythonCommand(   arguments:      "./x.py build --target x86_64-unknown-linux-gnu,#{Ism.settings.systemTarget}.json",
    ...
    def prepareInstallation
        ...
        runPythonCommand(   arguments:      "./x.py install --target x86_64-unknown-linux-gnu,#{Ism.settings.systemTarget}.json",
                            path:           buildDirectoryPath,
